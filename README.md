<!-- migrate-repo:banner -->
> [!IMPORTANT]
> **This repository has moved to [`schubergphilis-ep/terraform-aws-mcaf-route53-profiles`](https://github.com/schubergphilis-ep/terraform-aws-mcaf-route53-profiles).**
